...
class MultiCertDemo < DemoBase

  def MultiCertDemo.demoTrade
    req = {}
    ...
    # 签名示例
    Com::UnionPay::Acp::Sdk::AcpService.sign(req, "/Users/pridas/Sites/certs/acp_test_sign.pfx", "000000")
    ...
    if resp["respCode"]
      ...
      if resp["customerInfo"]
        customerInfo = Com::UnionPay::Acp::Sdk::AcpService.parseCustomerInfo(resp["customerInfo"], "/Users/pridas/Sites/certs/acp_test_sign.pfx", "000000")
