...
class MultiKeyDemo < DemoBase

  def MultiKeyDemo.demoTrade
    req = {}
    ...
    # 签名示例
    Com::UnionPay::Acp::Sdk::AcpService.signBySecureKey(req, '88888888')
    ...
    #验签示例
    result = result + (Com::UnionPay::Acp::Sdk::AcpService.validateBySecureKey(resp, '88888888') ? "验签成功<br>\n" : "验签失败<br>\n")
