...
class BatTrans < DemoBase

  def BatTrans.demoTrade
    req = {}
    ...
    req["totalQty"] = "10"
    req["totalAmt"] = "1000"
    req["fileContent"] = Com::UnionPay::Acp::Sdk::AcpService.enCodeFileContent("d:/file/DF00000000777290058110097201507140002I.txt")
